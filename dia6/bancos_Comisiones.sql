...
CREATE TABLE `Comisiones` (
  ...
  KEY `fk_Comisiones_maestroCuenta_idx` (`idTipoCuenta`),
  CONSTRAINT `fk_Comisiones_maestroCuenta` FOREIGN KEY (`idTipoCuenta`) REFERENCES `MaestroCuentas` (`idTipoCuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION
