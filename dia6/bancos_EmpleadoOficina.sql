...
CREATE TABLE `EmpleadoOficina` (
  ...
  KEY `fk_EmpleadoOficina_Oficina_idx` (`idOficina`),
  CONSTRAINT `fk_EmpleadoOficina_Empleado` FOREIGN KEY (`idEmpleado`) REFERENCES `Empleado` (`idEmpleado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_EmpleadoOficina_Oficina` FOREIGN KEY (`idOficina`) REFERENCES `Oficina` (`idOficina`) ON DELETE NO ACTION ON UPDATE NO ACTION
